import {expect,test} from 'bun:test';import {mkdtempSync,rmSync} from 'node:fs';import {tmpdir} from 'node:os';import {join} from 'node:path';import {singlePressBehavior} from '../../studio/document';import {SignalStore} from './store';import {startPresentationService} from './presentation';
